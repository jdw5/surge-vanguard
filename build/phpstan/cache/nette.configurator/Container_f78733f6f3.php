...
class Container_f78733f6f3 extends _PHPStan_cc8d35ffb\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService049(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_f78733f6f3 $container)
			{
	...
	public function createServiceContainer(): Container_f78733f6f3
	{
		return $this;
	}
